...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (form) {
        ...
        form.addEventListener('submit', function (e) {
            ...
            const checkUrl = 'https://script.google.com/macros/s/AKfycbzd1JTYZ96DHkKU3NMInmV9BIUDa5ogEy-ZUXYFTzSAK_sl2iRX7pB7oERHcFXc4cVn/exec?check=duplicate&phone=' + encodeURIComponent(phone) + '&date=' + encodeURIComponent(date);
    ...
    function proceedToPayment(url, type) {
        ...
        fetch("https://script.google.com/macros/s/AKfycbzd1JTYZ96DHkKU3NMInmV9BIUDa5ogEy-ZUXYFTzSAK_sl2iRX7pB7oERHcFXc4cVn/exec", {
            method: "POST",
            mode: "no-cors",
    ...
    function checkAvailability(date) {
        ...
        const url = 'https://script.google.com/macros/s/AKfycbzd1JTYZ96DHkKU3NMInmV9BIUDa5ogEy-ZUXYFTzSAK_sl2iRX7pB7oERHcFXc4cVn/exec?date=' + date + '&barber=' + barber;
